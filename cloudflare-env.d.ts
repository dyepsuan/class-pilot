/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: a19d2d41c9c0cb911bfd762061249ff7)
// Runtime types generated with workerd@1.20260815.1 2026-08-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DROPBOX_BUCKET: R2Bucket;
	class_pilot_dropbox: R2Bucket;
	LABORATORY_SUBMISSIONS: R2Bucket;
	DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QR_SIGNING_SECRET" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "GMAIL_TOKEN_ENCRYPTION_KEY" | "APP_BASE_URL">> {}
}
